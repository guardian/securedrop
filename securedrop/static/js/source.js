...
function checkClearnet() {
  ...
  let allowed = ["127.0.0.1", "localhost", "demo-source.securedrop.org", "demo-journalist.securedrop.org", "staging-demo-source.securedrop.org", "staging-demo-journalist.securedrop.org"];
